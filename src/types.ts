 ...
 */
export type RateLimitErrorResponseDTO = {
  retry_after: number;
} & ErrorResponseDTO;
 ...
 */
export type CreateCalorieGoalRequestDTO = {
  daily_goal: number;
};
 ...
 */
export type UpdateCalorieGoalRequestDTO = {
  daily_goal: number;
};
 ...
 */
export type CreateAIGenerationRequestDTO = {
  prompt: string;
};
 ...
 */
export type MealAIGenerationInfoDTO = {
  id: string;
  prompt: string;
 ...
 */
export type CreateAIMealRequestDTO = {
  input_method: "ai";
  ai_generation_id: string;
} & CreateMealBaseRequestDTO;

/**
 * Create manual meal request
 * No ai_generation_id required
 */
export type CreateManualMealRequestDTO = {
  input_method: "manual";
} & CreateMealBaseRequestDTO;
 ...
 */
export type UpdateMealResponseDTO = {
  warnings: MealWarningDTO[];
} & Tables<"meals">;
 ...
 */
export type DailyProgressResponseDTO = {
  date: string;
  user_id: string;
