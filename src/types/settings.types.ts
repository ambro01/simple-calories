 ...
 */
export type EditCalorieGoalViewModel = {
 ...
 */
export type EditCalorieGoalDialogProps = {
 ...
 */
export type LogoutAlertDialogProps = {
  open: boolean; // Czy dialog jest otwarty
  onOpenChange: (open: boolean) => void; // Handler zmiany stanu otwarcia
 ...
 */
export type CalorieGoalFormData = {
 ...
 * Zawiera stan formularza i walidacji
 */
export type ChangePasswordViewModel = {
